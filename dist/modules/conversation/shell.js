...
module.exports = function ComponentShell(config, registry) {
    ...
    return {
        ...
        getAllComponentMetadata: function () {
            ...
            var allMetadata = { version: sdk_1.ComponentInvocation.sdkVersion(), components: allComponents };
            return allMetadata;
        },
        /**
        ...
        invokeComponentByName: function (componentName, requestBody, sdkMixin, callback) {
            ...
            try {
                sdk = Object.assign(new sdk_1.ComponentInvocation(requestBody), sdkMixin);
            }
            catch (err) {
