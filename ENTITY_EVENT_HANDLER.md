...
- [Code Samples](#samples)
    ...
    - [How to send acknowledgement messages for updated items or items resolved out of order](#acknowledge)
    - [How to set or update bag items](#update)
    - [How to use custom events](#custom)
    - [How to invoke a REST API](#rest)
...
### How to invoke a REST API <a name="rest">
