import { LlmComponentContext
  , LlmComponentHandler
  , LlmComponentHandlers
  , LlmComponentHandlerMetadata
  , ValidateRequestEvent
  , ValidateResponseEvent
  , ChangeBotMessagesLlmEvent
  , SubmitEvent
  , NonRawMessage
...
export class {{className}} implements LlmComponentHandler {
  ...
  public handlers(): LlmComponentHandlers {
    return {
      ...
      */
       ...
       * @param {ChangeBotMessagesLlmComponent} event - event object contains the following properties:
